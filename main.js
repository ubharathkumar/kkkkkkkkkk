...
var UserDetailComponent = /** @class */ (function () {
    ...
    UserDetailComponent.prototype.onSubmit = function () {
        ...
        this.userService.update(this.user).subscribe(function (u) {
            _this.userService.nameTerms.next();
            var url = '/';
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.login = function (loginForm) {
        var _this = this;
        console.log(loginForm, 'sevice login before......');
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["apiUrl"] + "/customer-login";
    ...
    UserService.prototype.signUp = function (user) {
        console.log(_models_User__WEBPACK_IMPORTED_MODULE_7__["User"], 'Iam from ssssssssssssssssssssssss');
        console.log(user, 'I am before service');
        //const url = `${apiUrl}/register`;
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["apiUrl"] + "/customer-registration";
...
var apiUrl = 'http://165.22.209.195:3002';
//export const apiUrl = 'http://192.168.1.19:3000';
